...
import libfin.config
from libfin.cli import add_version, print_banner
from libfin.mciipm import IpmReader, IpmWriter
...
def get_config():
    ...
    """
    config = copy.deepcopy(libfin.config.config)
